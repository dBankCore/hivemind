...
POST_1 = {
    ...
    "depth": 0,
    "id": 4437869,
    "json_metadata": "{\"tags\":[\"spam\"],\"image\":[\"https://pbs.twimg.com/media/DBgNm3jXoAAioyE.jpg\"],\"app\":\"dsite/0.1\",\"format\":\"markdown\"}",
...
def test_post_basic():
    ...
    expect = {'json_metadata': {'tags': ['spam'], 'image': ['https://pbs.twimg.com/media/DBgNm3jXoAAioyE.jpg'], 'app': 'dsite/0.1', 'format': 'markdown'},
